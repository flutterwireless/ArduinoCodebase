...
static interruptCB callbacksSW[1];

uint16_t _swInterrupt = 0;
...
static void __initialize() {
	...
	NVIC_SetPriority(PIOA_IRQn, 15); //FLUTTER: changed priority to a level lower than that of systick.
...
void PIOA_Handler(void) {
	...
	if(_swInterrupt==1) //software interrupt got us here
	{
		_swInterrupt=0;
		callbacksSW[0]();
		return;
